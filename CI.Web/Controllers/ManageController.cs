...
namespace CI.Web.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        [HttpGet]
        public async Task<IActionResult> Disable2faWarnings()
        {
            var user = await _userManager.GetUserAsync(User);
            if (user == null)
            {
        ...
        public async Task<IActionResult> Disable2fa()
        {
            ...
            return RedirectToPage(nameof(TwoFactorAuthentication));
        }
        ...
        public async Task<IActionResult> DownloadPersonalData()
        {
            ...
            var personalDataProps = typeof(CoreIdentityTemplateIdentityUser).GetProperties().Where(
        ...
        public async Task<IActionResult> ResetAuthenticator()
        {
            ...
            return RedirectToAction(nameof(ResetAuthenticatorAction));
        }


        [HttpPost]
        public async Task<IActionResult> ResetAuthenticatorAction()
        {
            var user = await _userManager.GetUserAsync(User);
            if (user == null)
            {
        ...
        private async Task LoadSharedKeyAndQrCodeUriAsync(CoreIdentityTemplateIdentityUser user, EnableAuthenticatorViewModel model)
        {
        ...
        public async Task<IActionResult> ExternalLogins()
        {
            ...
            {
                CurrentLogins = await this._userManager.GetLoginsAsync(user)
        };
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> RemoveLogins(string loginProvider, string providerKey)
        {
            var user = await _userManager.GetUserAsync(User);
            if (user == null)
            {
